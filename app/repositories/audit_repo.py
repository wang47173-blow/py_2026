...
async def insert_query_log(*, query_id: str, tenant_id: str, user_id: str, question_hash: str, top_k: int, latency_ms: int) -> None:
...
async def insert_query_chunks(*, query_id: str, chunks: list[dict]) -> None:
    async with engine.begin() as conn:
